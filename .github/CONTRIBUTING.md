...
2. **It handles children's voice recordings.** Recordings never leave the device
   ...
   (see [`SECURITY.md`](SECURITY.md) and `docs/architecture/DECISIONS.md` D-008).
...
- [`docs/architecture/PLAN.md`](../docs/architecture/PLAN.md) — the working plan and the canonical
  **verification commands** (kept in sync with reality).
- [`docs/roadmap/ROADMAP.md`](../docs/roadmap/ROADMAP.md) — the prioritized list (P0–P3 + X).
- [`docs/roadmap/ROADMAP_STATUS.md`](../docs/roadmap/ROADMAP_STATUS.md) — the traceability matrix;
  **update it if your change moves a roadmap item's tier or status.**
- [`docs/architecture/DECISIONS.md`](../docs/architecture/DECISIONS.md) — the decision log (read the tier system below).
- [`docs/roadmap/PHASE0_STATUS.md`](../docs/roadmap/PHASE0_STATUS.md) — what is real vs. simulated.
...
behind markers (see `docs/architecture/DECISIONS.md` D-002). On a machine with `[ml]` installed
and ffmpeg on `PATH`:
...
this is decision **D-001** in [`docs/architecture/DECISIONS.md`](../docs/architecture/DECISIONS.md):
...
traceability matrix (`docs/roadmap/ROADMAP_STATUS.md`) so it stays the authoritative
...
to [`docs/architecture/DECISIONS.md`](../docs/architecture/DECISIONS.md)** — don't open a discussion thread to ask.
...
verified licenses are tracked in [`docs/architecture/THIRD_PARTY.md`](../docs/architecture/THIRD_PARTY.md);
